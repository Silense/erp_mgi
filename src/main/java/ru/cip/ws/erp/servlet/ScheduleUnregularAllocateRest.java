 ...
 */
@RestController
@RequestMapping("/schedule/unregular.allocate")
public class ScheduleUnregularAllocateRest {
    ...
    @Autowired
    @Qualifier("unregularAllocateTrigger")
    private Trigger trigger;

    @Autowired
    @Qualifier("unregularAllocateJobDetail")
    ...
    private String setScheduleExpression(final String cronExpression) {
        ...
        try {
            ...
            cfg.set(CFG_KEY_SCHEDULE_UNREGULAR_ALLOCATE, cronExpression);
