...
import static ru.cip.ws.erp.ConfigurationHolder.CFG_KEY_SCHEDULE_UNREGULAR_REALLOCATE;
 ...
 */
@RestController
@RequestMapping("/schedule/unregular.reAllocate")
public class ScheduleUnregularReAllocateRest {
    ...
    @Autowired
    @Qualifier("unregularReAllocateTrigger")
    private Trigger trigger;

    @Autowired
    @Qualifier("unregularReAllocateJobDetail")
    ...
    private String setScheduleExpression(final String cronExpression) {
        ...
        try {
            ...
            cfg.set(CFG_KEY_SCHEDULE_UNREGULAR_REALLOCATE, cronExpression);
